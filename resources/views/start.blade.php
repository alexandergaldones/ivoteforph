	...
	<body>
		<div class="container">
			<header class="clearfix">
				<span>IVoteForPH.com <span class="bp-icon bp-icon-about" data-content="The Blueprints are a collection of basic and minimal website concepts, components, plugins and layouts with minimal style for easy adaption and usage, or simply for inspiration."></span></span>
				<h1>Philippine Election 2016 Candidates</h1>
				<nav>
			...
			<div id="grid-gallery" class="grid-gallery">
				<section class="grid-wrap">
					<ul class="grid">
						...
						<li>
							<figure>
								<img src="http://lorempixel.com/238/238" alt="img03"/>
						...
						<li>
							<figure>
								<img src="http://lorempixel.com/238/238" alt="img04"/>
						...
						<li>
							<figure>
								<img src="http://lorempixel.com/238/238" alt="img05"/>
						...
						<li>
							<figure>
								<img src="http://lorempixel.com/238/238" alt="img06"/>
					...
					<ul>
						<li>
							<figure>
								...
								<img src="http://lorempixel.com/560/320" alt="img01"/>
							</figure>
						</li>
						<li>
							<figure>
								...
								<img src="http://lorempixel.com/560/320" alt="img02"/>
							</figure>
						</li>
						<li>
							<figure>
								...
								<img src="http://lorempixel.com/560/320" alt="img03"/>
							</figure>
						</li>
						<li>
							<figure>
								...
								<img src="http://lorempixel.com/560/320" alt="img04"/>
							</figure>
						</li>
						<li>
							<figure>
								...
								<img src="http://lorempixel.com/560/320" alt="img05"/>
							</figure>
						</li>
						<li>
							<figure>
								...
								<img src="http://lorempixel.com/560/320" alt="img06"/>
							</figure>
						</li>						
					</ul>
					<nav>
